document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderActivityCard(name, details) {
    ...
    const difficultyHtml = `<span class="difficulty-badge difficulty-${difficulty.toLowerCase()}">${difficulty}</span>`;
    ...
    activityCard.innerHTML = `
      ...
      <div class="share-buttons">
        ...
        <button class="share-btn share-twitter" data-activity="${name}" title="Share on X (Twitter)">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="14" height="14"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
        </button>
    ...
    activityCard.querySelector(".share-copy").addEventListener("click", (event) => {
      shareActivity(name, "copy", event.currentTarget);
    });
  ...
  function shareActivity(activityName, platform, buttonEl) {
    ...
    if (platform === "whatsapp") {
      ...
      navigator.clipboard.writeText(shareUrl).then(() => {
        ...
        setTimeout(() => { buttonEl.title = "Copy link"; }, 2000);
      });
    }
  }
